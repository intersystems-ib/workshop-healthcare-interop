...
- `ORUR01_*.hl7` are starter HL7 ORU^R01 messages you can copy into `labworkflow/in/`
- `labworkflow/in/` is the inbound watch folder used to simulate lab result delivery
- `labworkflow/inarchive/` stores processed inbound Lab Workflow files
- `labworkflow/out/` stores generated output files from the Lab Workflow scenario
