...
- [labworkflow-orders.http](/Users/afuentes/Documents/ISC/workspace/workshop-healthcare-interop/http/labworkflow-orders.http)
...
- `labworkflow-orders.http` covers the three HIS order examples.
